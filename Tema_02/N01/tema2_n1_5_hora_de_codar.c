// Nem tentei entender isso daqui
// Já estou no tema 2 e ainda não entendi nem qual que é a vantagem de um ponteiro
// Fora que esta aula sobrecarrega muito o aluno, olha o tamanho desse código, nem cheguei a rodar pra testar
// Péssima aula...
...
void liberarListaEncadeada(ListaEncadeada *lista) {
    ...
    while (atual != NULL) {
        ...
        free(atual->dado);
        free(atual);
        // e foda-se o resto do código, nem deu pra ver no videoaula, nem da pra saber se tem mais coisa depois do while...
    }
}